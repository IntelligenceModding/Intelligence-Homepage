...
export default function NotFound() {
    return (
        <div className="bg-white dark:bg-slate-800 justify-between">
            <div className="mx-auto w-full max-w-7xl px-6 pb-16 pt-10 sm:pb-24 lg:px-8">
                ...
                <div className="mx-auto mt-20 max-w-2xl text-center sm:mt-24">
                    <h1 className="mt-4 text-3xl dark:text-white font-bold tracking-tight text-gray-900 sm:text-5xl">Begone, this is not
